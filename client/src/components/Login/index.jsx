...
const Login = ({ setLogged, setUser }) => {
  ...
  const authenticateUser = () => {
    if (attemptedUser && attemptedPassword) {
      // TODO: AUTHENTICATE
  ...
  return (
    <div id="login-page">
      <div id="login-img-panel">
        <img id="login-img" src="./images/login_img.jpg" alt="Login page panel" />
      </div>
        ...
        <div id="login-form-elements">
          ...
          <form id="login-form" onSubmit={e => handleFormSubmit(e)}>
            <input
              ...
              onChange={({ target }) => setAttemptedUser(target.value)}
            />
            <datalist id="users">
              <option value={lastUser} />
            </datalist>
            <input
              type="password"
              placeholder="Password"
              autoComplete="password"
              onChange={({ target }) => setAttemptedPassword(target.value)}
            />
          </form>
